            ...
            existingTask.forEach(tasks => {
                ...
                <div class="flex gap-3 items-center">
                    ...
                    <div class="flex flex-col">
                        <p class="font-bold text-lg leading-[27px]">${tasks.taskName}</p>
                        <p class="text-sm leading-[21px] text-taskia-grey">Created at ${tasks.createdAt}</p>
                    </div>
                </div>
